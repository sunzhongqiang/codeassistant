...
import AngularCodeGengerator from '../../generator/AngularCodeGengerator'
const confirm = Modal.confirm

export class AngularModel extends Component {
  state = {
    layer: '',
    filename: '',
    layerList: [
  ...
  generatorCode (value) {
    ...
    let filename = ''
    if('model'===value){
      code = AngularCodeGengerator.generatorModelCode()
    }
